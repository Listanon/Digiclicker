...
export default class OakItems implements Feature {
    ...
    initialize() {
        this.itemList = [
            ...
            new BoughtOakItem(OakItemType.Demo_Disk, 'Demo Disk', 'Increases the chance of disk modifications', 'Tyutyumon\'s Server Branch',
            ...
            new BoughtOakItem(OakItemType.Failure_Prevent, 'Failure Prevent', 'Increases the chance of disk replacing', 'Tyutyumon\'s Server Branch',
            ...
            new BoughtOakItem(OakItemType.Golden_DVD, 'Golden DVD', 'All new mining layers start with damaged tiles', 'Whamon\'s Gulf Shop',
            ...
            new BoughtOakItem(OakItemType.Shiny_Mirror, 'Shiny Mirror', 'Chance to multiply mining rewards', 'Whamon\'s Gulf Shop',
