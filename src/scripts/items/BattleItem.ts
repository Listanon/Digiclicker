...
ItemList['Lucky_floppy']   = new BattleItem(GameConstants.BattleItemType.Lucky_floppy, '+50% Bonus to money gained for 30 seconds', 2000, undefined, 'Lucky Incense', 'money', 1.5);
