...
ItemList['Lucky_pill']       = new BattleItem(GameConstants.BattleItemType.Lucky_pill, '+50% Bonus to experience gained for 30 seconds', 800, undefined, 'Lucky Egg', 'exp', 1.5);
ItemList['Intel_floppy'] = new BattleItem(GameConstants.BattleItemType.Intel_floppy, '+50% Bonus to scan coins gained for 30 seconds', 1000, undefined, 'Intel Pill', 'explorecoin', 1.5);
