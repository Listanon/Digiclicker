...
ItemList['Intel Floppy'] = new BattleItem(GameConstants.BattleItemType.Intel_Floppy, '+50% Bonus to scan coins gained for 30 seconds', 1000, undefined, 'Intel Floppy', 'explorecoin', 1.5);
