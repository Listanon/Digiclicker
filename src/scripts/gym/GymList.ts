...
GymList['Ocean Data'] = new Gym(
    ...
    [
        ...
        new GymPokemon('Waru Seadramon', 33623, 47),
...
GymList['Forest Data'] = new Gym(
    ...
    [
        ...
        new GymPokemon('Delumon', 34552, 48),
...
GymList['City Data'] = new Gym(
    ...
    [
        ...
        new GymPokemon('Megadramon', 35497, 49),
...
GymList['Wasteland Data'] = new Gym(
    ...
    [
        ...
        new GymPokemon('Waru Monzaemon', 36456, 50),
...
GymList['Apocalymon Data'] = new Champion(
    ...
    [
        ...
        new GymPokemon('King Etemon', 38431, 52),
        new GymPokemon('Apocalymon', 70000, 53),
    ],
    // Punimon
    [
        new GymPokemon('Skull Mammon', 38431, 52),
