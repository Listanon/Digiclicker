...
dungeonList['Viridian Forest'] = new Dungeon('Viridian Forest',
    [
        ...
        new DungeonTrainer('Bug Catcher',
            [
                new GymPokemon('Dokunemon', 50, 6),
                new GymPokemon('Dokunemon', 50, 6),
            ], { weight: 1 }, 'Rick'),
        new DungeonTrainer('Bug Catcher',
            [
                new GymPokemon('Kokuwamon', 50, 7),
                new GymPokemon('Kokuwamon', 50, 7),
                new GymPokemon('Mushmon', 50, 7),
            ], { weight: 1 }, 'Doug'),
        new DungeonTrainer('Bug Catcher',
            [
                new GymPokemon('Mushmon', 50, 7),
                new GymPokemon('Betamon', 50, 8),
            ], { weight: 1 }, 'Anthony'),
        new DungeonTrainer('Bug Catcher',
            [
                new GymPokemon('Mushmon', 50, 7),
                new GymPokemon('Kokuwamon', 50, 7),
                new GymPokemon('Dokunemon', 50, 7),
            ], { weight: 1 }, 'Charlie'),
    ],
    [
        ...
        {loot: 'Plant_egg', weight: 1, requirement: new ClearDungeonRequirement(100, GameConstants.getDungeonIndex('Viridian Forest'))},
        {loot: 'Leaf_stone', weight: 0},
    ],
    102,
    [
        new DungeonBossPokemon('Shellmon', 510, 7),
        new DungeonTrainer('Bug Catcher',
            [new GymPokemon('Mori Shellmon', 510, 9)],
            { weight: 1 }, 'Sammy'),
    ],
    50, 2);

dungeonList['Digletts Cave Pewter'] = new Dungeon('Digletts Cave Pewter',
    [
        ...
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Fugamon', 50, 6),
                new GymPokemon('Minotaurmon', 50, 6),
            ], { weight: 1 }, 'Mac'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Meramon', 50, 7),
                new GymPokemon('Meramon', 50, 7),
                new GymPokemon('Golemon', 50, 7),
            ], { weight: 1 }, 'Zane'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Flare Lizarmon', 50, 7),
                new GymPokemon('Drimogemon', 50, 8),
            ], { weight: 1 }, 'Joseph'),
        new DungeonTrainer('Lass',
            [
                new GymPokemon('Drimogemon', 50, 7),
                new GymPokemon('Drimogemon', 50, 7),
                new GymPokemon('Nise Drimogemon', 50, 7),
            ], { weight: 1 }, 'Nina'),
    ],
    [
        {loot: 'xClick', weight: 4},
        {loot: 'Lucky_floppy', weight: 4},
        {loot: 'Mystery_egg', weight: 1, requirement: new ClearDungeonRequirement(100, GameConstants.getDungeonIndex('Digletts Cave Pewter'))},
        {loot: 'Max Revive', weight: 0},
        {loot: 'Backup', weight: 0},
    ],
    1208,
    [new DungeonBossPokemon('Skull Greymon', 6040, 31)],
    650, 11);
...
dungeonList['Mt. Moon'] = new Dungeon('Mt. Moon',
    [
        ...
        new DungeonTrainer('Bug Catcher',
            [
                new GymPokemon('Goburimon', 75, 11),
                new GymPokemon('Shamamon', 75, 11),
            ], { weight: 1 }, 'Kent'),
        new DungeonTrainer('Lass',
            [new GymPokemon('Candmon', 75, 14)],
            { weight: 1 }, 'Iris'),
        new DungeonTrainer('Super Nerd',
            [
                new GymPokemon('Clear Agumon', 75, 11),
                new GymPokemon('Clockmon', 75, 11),
            ], { weight: 1 }, 'Jovan'),
        new DungeonTrainer('Bug Catcher',
            [
                new GymPokemon('Mechanorimon', 75, 10),
                new GymPokemon('Hagurumon', 75, 10),
                new GymPokemon('Hagurumon', 75, 10),
            ], { weight: 1 }, 'Robby'),
        new DungeonTrainer('Lass',
            [
                new GymPokemon('Clockmon', 75, 11),
                new GymPokemon('Gottsumon', 75, 11),
            ], { weight: 1 }, 'Miriam'),
        new DungeonTrainer('Youngster',
            [
                new GymPokemon('Gottsumon', 75, 10),
                new GymPokemon('Gottsumon', 75, 10),
                new GymPokemon('Gottsumon', 75, 10),
            ], { weight: 1 }, 'Josh'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Guardromon', 75, 10),
                new GymPokemon('Gottsumon', 75, 10),
                new GymPokemon('Hagurumon', 75, 10),
            ], { weight: 1 }, 'Marcos'),
        new DungeonTrainer('Team Rocket Grunt',
            [
                new GymPokemon('Hagurumon', 75, 11),
                new GymPokemon('Goburimon', 75, 11),
                new GymPokemon('Goburimon', 75, 11),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Rocket Grunt',
            [
                new GymPokemon('Hagurumon', 75, 13),
                new GymPokemon('Goburimon', 75, 13),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Rocket Grunt',
            [
                new GymPokemon('Goburimon', 75, 13),
        ...
        new DungeonTrainer('Team Rocket Grunt',
            [
                new GymPokemon('Toy Agumon', 75, 13),
                new GymPokemon('Toy Agumon', 75, 13),
            ], { weight: 1 }, undefined, '(male)'),
    ],
    [
    ...
    834,
    [
        new DungeonBossPokemon('Andromon', 20585, 17),
        new DungeonBossPokemon('Guardromon', 20585, 17),
    ],
    75, 4,
    () => {
...
dungeonList['Rock Tunnel'] = new Dungeon('Rock Tunnel',
    [
        ...
        new DungeonTrainer('PokéManiac',
            [
                new GymPokemon('Kokuwamon', 500, 23),
                new GymPokemon('Kokuwamon', 500, 23),
            ], { weight: 1 }, 'Ashton'),
        new DungeonTrainer('PokéManiac',
            [new GymPokemon('Leomon', 500, 25)],
            { weight: 1 }, 'Winston'),
        new DungeonTrainer('Picnicker',
            [
                new GymPokemon('Goburimon', 500, 22),
                new GymPokemon('Shamamon', 500, 22),
            ], { weight: 1 }, 'Martha'),
        new DungeonTrainer('PokéManiac',
            [
                new GymPokemon('Dokunemon', 500, 22),
                new GymPokemon('Dokunemon', 500, 22),
            ], { weight: 1 }, 'Steve'),
        new DungeonTrainer('Hiker',
            [new GymPokemon('Orgemon', 500, 25)],
            { weight: 1 }, 'Allen'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Hagurumon', 500, 20),
                new GymPokemon('Hagurumon', 500, 20),
            ], { weight: 1 }, 'Eric'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Kunemon', 500, 19),
                new GymPokemon('Kunemon', 500, 19),
                new GymPokemon('Numemon', 500, 19),
                new GymPokemon('Numemon', 500, 19),
            ], { weight: 1 }, 'Lenny'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Betamon', 500, 20),
                new GymPokemon('Betamon', 500, 20),
                new GymPokemon('Betamon', 500, 20),
            ], { weight: 1 }, 'Oliver'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Mushmon', 500, 21),
                new GymPokemon('Mushmon', 500, 21),
            ], { weight: 1 }, 'Lucas'),
        new DungeonTrainer('Picnicker',
            [
                new GymPokemon('Geremon', 500, 21),
                new GymPokemon('Mushmon', 500, 21),
                new GymPokemon('Geremon', 500, 21),
            ], { weight: 1 }, 'Sofia'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Geremon', 500, 21),
                new GymPokemon('Jungle Mojyamon', 500, 21),
                new GymPokemon('Geremon', 500, 21),
            ], { weight: 1 }, 'Dudley'),
        new DungeonTrainer('PokéManiac',
            [
                new GymPokemon('Toy Agumon', 500, 20),
                new GymPokemon('Shamamon', 500, 20),
                new GymPokemon('Shakomon', 500, 20),
            ], { weight: 1 }, 'Cooper'),
        new DungeonTrainer('Picnicker',
            [
                new GymPokemon('Shakomon', 500, 22),
                new GymPokemon('Shakomon', 500, 22),
            ], { weight: 1 }, 'Leah'),
        new DungeonTrainer('Picnicker',
            [
                new GymPokemon('Palmon', 500, 20),
                new GymPokemon('Alraumon', 500, 20),
                new GymPokemon('Alraumon', 500, 20),
            ], { weight: 1 }, 'Dana'),
    ],
    [
    ...
    4117,
    [
        new DungeonBossPokemon('Centalmon', 20585, 17),
        new DungeonTrainer('Picnicker',
            [
                new GymPokemon('Dokunemon', 5147, 19),
                new GymPokemon('Dokunemon', 5147, 19),
                new GymPokemon('Goburimon', 5147, 19),
                new GymPokemon('Goburimon', 5147, 19),
            ], { weight: 1 }, 'Ariana'),
    ],
    500, 7);

dungeonList['Pokemon Tower 2'] = new Dungeon('Pokemon Tower 2',
    [
        ...
        new DungeonTrainer('PokéManiac',
            [
                new GymPokemon('Tortamon', 500, 23),
                new GymPokemon('Tortamon', 500, 23),
            ], { weight: 1 }, 'Duke'),
        new DungeonTrainer('PokéManiac',
            [new GymPokemon('Starmon', 500, 25)],
            { weight: 1 }, 'Cliff'),
        new DungeonTrainer('Picnicker',
            [
                new GymPokemon('Revolmon', 500, 22),
                new GymPokemon('Tyranomon', 500, 22),
            ], { weight: 1 }, 'Clyde'),
        new DungeonTrainer('PokéManiac',
            [
                new GymPokemon('Andromon', 500, 22),
                new GymPokemon('Blikmon', 500, 22),
            ], { weight: 1 }, 'Vinny'),
        new DungeonTrainer('Hiker',
            [new GymPokemon('Nise Drimogemon', 500, 25)],
            { weight: 1 }, 'Greyson'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Monochromon', 500, 20),
                new GymPokemon('Monochromon', 500, 20),
            ], { weight: 1 }, 'Vlad'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Guardromon', 500, 19),
                new GymPokemon('Guardromon', 500, 19),
                new GymPokemon('Guardromon', 500, 19),
                new GymPokemon('Hyougamon', 500, 19),
            ], { weight: 1 }, 'Luke'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Greymon', 500, 20),
                new GymPokemon('Yanmamon', 500, 20),
                new GymPokemon('Yanmamon', 500, 20),
            ], { weight: 1 }, 'Carlos'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Yukidarumon', 500, 21),
                new GymPokemon('Yukidarumon', 500, 21),
            ], { weight: 1 }, 'Jan'),
        new DungeonTrainer('Picnicker',
            [
                new GymPokemon('Unimon', 500, 21),
                new GymPokemon('Unimon', 500, 21),
                new GymPokemon('Unimon', 500, 21),
            ], { weight: 1 }, 'Kathrin'),
        new DungeonTrainer('Hiker',
...
dungeonList['Power Plant'] = new Dungeon('Power Plant',
    ...
    [
        ...
        {loot: 'Water_egg', weight: 1, requirement: new ClearDungeonRequirement(100, GameConstants.getDungeonIndex('Power Plant'))},
        {loot: 'Max Revive', weight: 0},
    ...
    13507,
    [
        new DungeonBossPokemon('Whamon Perfect', 67535, 35),
        new DungeonBossPokemon('Metal Seadramon', 101302, 50),
    ],
    1000, 20);
...
dungeonList['Pokemon Tower'] = new Dungeon('Pokemon Tower',
    [
        ...
        new DungeonTrainer('Channeler',
            [new GymPokemon('Bakemon', 750, 23)],
            { weight: 1 }, 'Hope'),
        new DungeonTrainer('Channeler',
            [new GymPokemon('Bakemon', 750, 22)],
            { weight: 1 }, 'Patricia'),
        new DungeonTrainer('Channeler',
            [new GymPokemon('Soulmon', 750, 24)],
            { weight: 1 }, 'Carly'),
        new DungeonTrainer('Channeler',
            [
                new GymPokemon('Bakemon', 750, 23),
                new GymPokemon('Soulmon', 750, 23),
            ], { weight: 1 }, 'Laurel'),
        new DungeonTrainer('Channeler',
            [new GymPokemon('Bakemon', 750, 22)],
            { weight: 1 }, 'Jody'),
        new DungeonTrainer('Channeler',
            [new GymPokemon('Bakemon', 750, 24)],
            { weight: 1 }, 'Paula'),
        new DungeonTrainer('Channeler',
            [new GymPokemon('Soulmon', 750, 22)],
            { weight: 1 }, 'Ruth'),
        new DungeonTrainer('Channeler',
            [new GymPokemon('Bakemon', 750, 23)],
            { weight: 1 }, 'Tammy'),
        ...
        new DungeonTrainer('Channeler',
            [
                new GymPokemon('Tukaimon', 750, 22),
                new GymPokemon('Tukaimon', 750, 22),
                new GymPokemon('Goburimon', 750, 22),
            ], { weight: 1 }, 'Angelica'),
        new DungeonTrainer('Channeler',
            [new GymPokemon('Bakemon', 750, 24)],
            { weight: 1 }, 'Jennifer'),
        ...
        new DungeonTrainer('Team Rocket Grunt',
            [
                new GymPokemon('Tukaimon', 750, 25),
                new GymPokemon('Tukaimon', 750, 25),
                new GymPokemon('Tukaimon', 750, 25),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Rocket Grunt',
            [
                new GymPokemon('Soulmon', 750, 26),
                new GymPokemon('Soulmon', 750, 26),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Rocket Grunt',
            [
                new GymPokemon('Soulmon', 750, 23),
                new GymPokemon('Soulmon', 750, 23),
                new GymPokemon('Tukaimon', 750, 23),
                new GymPokemon('Tukaimon', 750, 23),
            ], { weight: 1 }, undefined, '(male)'),
    ],
    [
        ...
        {loot: 'Earth_egg', weight: 1, requirement: new ClearDungeonRequirement(100, GameConstants.getDungeonIndex('Pokemon Tower'))},
    ...
    7523,
    [new DungeonBossPokemon('Devimon', 37615, 30)],
    750, 10);
...
dungeonList['Seafoam Islands'] = new Dungeon('Seafoam Islands',
    ...
    17226,
    [
        new DungeonBossPokemon('Skull Mammon', 86130, 35),
        new DungeonBossPokemon('Venom Vamdemon', 129195, 50),
    ],
    1250, 19);

dungeonList['Seafoam Islands 2'] = new Dungeon('Seafoam Islands',
    ['Jyagamon', 'Ookuwamon', 'Pumpmon', 'Gerbemon', 'Vermillimon', 'Ex-Tyranomon', 'Delumon', 'Kiwimon', 'Floramon', 'Woodmon'],
    [
        {loot: 'xAttack', weight: 4},
        {loot: 'Light', weight: 3.5},
        {loot: 'Revive', weight: 1.75},
        {loot: 'Plant_egg', weight: 1, requirement: new ClearDungeonRequirement(100, GameConstants.getDungeonIndex('Seafoam Islands'))},
        {loot: 'Ultraball', weight: 1},
        {loot: 'Leaf_stone', weight: 0},
    ],
    17226,
    [
        new DungeonBossPokemon('Jyureimon', 86130, 35),
        new DungeonBossPokemon('Pinochimon', 129195, 50),
    ],
    1250, 21);
...
dungeonList['Pokemon Mansion'] = new Dungeon('Pokemon Mansion',
    [
        ...
        new DungeonTrainer('Youngster',
            [
                new GymPokemon('Musyamon', 1500, 33),
                new GymPokemon('Numemon', 1500, 33),
                new GymPokemon('Numemon', 1500, 34),
            ], { weight: 1 }, 'Johnson'),
        new DungeonTrainer('Burglar',
            [
                new GymPokemon('Saberdramon', 1500, 34),
                new GymPokemon('Saberdramon', 1500, 34),
            ], { weight: 1 }, 'Arnie'),
        new DungeonTrainer('Burglar',
            [new GymPokemon('Igamon', 1500, 38)],
            { weight: 1 }, 'Simon'),
        new DungeonTrainer('Scientist',
            [
                new GymPokemon('Gorimon', 1500, 33),
                new GymPokemon('Fugamon', 1500, 33),
                new GymPokemon('Hanumon', 1500, 33),
            ], { weight: 1 }, 'Braydon', '(male)'),
        new DungeonTrainer('Scientist',
            [
                new GymPokemon('Geremon', 1500, 29),
                new GymPokemon('Numemon', 1500, 29),
            ], { weight: 1 }, 'Ted', '(male)'),
        new DungeonTrainer('Burglar',
            [
                new GymPokemon('Scumon', 1500, 34),
                new GymPokemon('Scumon', 1500, 34),
            ], { weight: 1 }, 'Lewis'),
        new DungeonTrainer('Scientist',
            [
                new GymPokemon('Igamon', 1500, 34),
                new GymPokemon('Blue Meramon', 1500, 34),
            ], { weight: 1 }, 'Ivan', '(male)'),
    ],
    [
        {loot: 'xAttack', weight: 4},
    ...
    17760,
    [new DungeonBossPokemon('Vamdemon', 88800, 40)],
    1500, 16);
...
dungeonList['Victory Road'] = new Dungeon('Victory Road',
    [
        ...
        new DungeonTrainer('Cooltrainer',
            [
                new GymPokemon('Megadramon', 2000, 42),
                new GymPokemon('Mammon', 2000, 42),
                new GymPokemon('Mammon', 2000, 42),
                new GymPokemon('Waru Seadramon', 2000, 42),
                new GymPokemon('Waru Seadramon', 2000, 42),
            ], { weight: 1 }, 'Naomi', '(female)'),
        new DungeonTrainer('Cooltrainer',
            [
                new GymPokemon('Ookuwamon', 2000, 42),
                new GymPokemon('Pumpmon', 2000, 42),
                new GymPokemon('Skull Satamon', 2000, 42),
                new GymPokemon('Triceramon', 2000, 42),
                new GymPokemon('Metal Mamemon', 2000, 42),
            ], { weight: 1 }, 'Rolando', '(male)'),
        new DungeonTrainer('Black Belt',
            [
                new GymPokemon('Metal Mamemon', 2000, 43),
                new GymPokemon('Mamemon', 2000, 43),
                new GymPokemon('Tyranomon', 2000, 43),
            ], { weight: 1 }, 'Daisuke'),
        new DungeonTrainer('Juggler',
            [
                new GymPokemon('Tyranomon', 2000, 41),
                new GymPokemon('Tyranomon', 2000, 41),
                new GymPokemon('Metal Tyranomon', 2000, 41),
                new GymPokemon('Metal Tyranomon', 2000, 41),
            ], { weight: 1 }, 'Nelson'),
        new DungeonTrainer('Tamer',
            [
                new GymPokemon('Lady Devimon', 2000, 44),
                new GymPokemon('Jyureimon', 2000, 44),
            ], { weight: 1 }, 'Vincent'),
        new DungeonTrainer('Juggler',
            [new GymPokemon('Boltmon', 2000, 48)],
            { weight: 1 }, 'Gregory'),
        new DungeonTrainer('Cooltrainer',
            [
                new GymPokemon('Etemon', 2000, 42),
                new GymPokemon('Etemon', 2000, 42),
                new GymPokemon('Fantomon', 2000, 42),
                new GymPokemon('Fantomon', 2000, 42),
                new GymPokemon('Digitamamon', 2000, 42),
            ], { weight: 1 }, 'George', '(male)'),
        new DungeonTrainer('PokéManiac',
            [
                new GymPokemon('Brachimon', 2000, 40),
                new GymPokemon('Atlur Kabuterimon Blue', 2000, 40),
                new GymPokemon('Atlur Kabuterimon Red', 2000, 40),
            ], { weight: 1 }, 'Dawson'),
        new DungeonTrainer('Cooltrainer',
            [
                new GymPokemon('Anomalocarimon', 2000, 42),
                new GymPokemon('Anomalocarimon', 2000, 42),
                new GymPokemon('Dagomon', 2000, 42),
                new GymPokemon('Dagomon', 2000, 42),
                new GymPokemon('Gesomon', 2000, 42),
            ], { weight: 1 }, 'Alexa', '(female)'),
        new DungeonTrainer('Cooltrainer',
            [
                new GymPokemon('Gigadramon', 2000, 41),
                new GymPokemon('Gigadramon', 2000, 42),
                new GymPokemon('Megadramon', 2000, 42),
                new GymPokemon('Megadramon', 2000, 42),
                new GymPokemon('Master Tyranomon', 2000, 42),
            ], { weight: 1 }, 'Colby', '(male)'),
        new DungeonTrainer('Cooltrainer',
            [
                new GymPokemon('Monzaemon', 2000, 42),
                new GymPokemon('Monzaemon', 2000, 42),
                new GymPokemon('Monzaemon', 2000, 42),
                new GymPokemon('Waru Monzaemon', 2000, 42),
                new GymPokemon('Waru Monzaemon', 2000, 42),
    ...
    [
        ...
        {loot: 'SmallRestore', weight: 1.75},
        {loot: 'Star Piece', weight: 1},
        {loot: 'Wind_egg', weight: 1, requirement: new ClearDungeonRequirement(100, GameConstants.getDungeonIndex('Victory Road'))},
        {loot: 'Leaf_stone', weight: 0},
        {loot: 'Max Revive', weight: 0},
        {loot: 'Heart Scale', weight: 0},
    ],
    24595,
    [
        new DungeonBossPokemon('King Etemon', 122975, 42),
        new DungeonBossPokemon('Piemon', 184462, 50),
...
dungeonList['Cerulean Cave'] = new Dungeon('Cerulean Cave',
    ...
    28735,
    [
        new DungeonBossPokemon('Infermon', 183675, 60),
