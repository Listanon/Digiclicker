...
dungeonList['Andromon\'s Factory'] = new Dungeon('Andromon\'s Factory',
    ...
    [
        ...
        {loot: 'Helix Fossil', weight: 0, requirement: new ClearDungeonRequirement(100, GameConstants.getDungeonIndex('Andromon\'s Factory'))},
        {loot: 'Dome Fossil', weight: 0, requirement: new ClearDungeonRequirement(100, GameConstants.getDungeonIndex('Andromon\'s Factory'))},
...
dungeonList['Our War Game'] = new Dungeon('Our War Game',
    ...
    [
        ...
        {loot: 'Old Amber', weight: 0, requirement: new ClearDungeonRequirement(100, GameConstants.getDungeonIndex('Our War Game'))},
        {loot: 'Max Revive', weight: 0},
