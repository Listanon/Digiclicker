...
dungeonList['Viridian Forest'] = new Dungeon('Viridian Forest',
    [
        ...
        new DungeonTrainer('Bug Catcher',
            [
                new GymPokemon('Burpmon', 50, 6),
                new GymPokemon('Burpmon', 50, 6),
            ], { weight: 1 }, 'Rick'),
        new DungeonTrainer('Bug Catcher',
            [
                new GymPokemon('Burpmon', 50, 7),
                new GymPokemon('Burpmon', 50, 7),
                new GymPokemon('Burpmon', 50, 7),
            ], { weight: 1 }, 'Doug'),
        new DungeonTrainer('Bug Catcher',
    ...
    102,
    [
        new DungeonBossPokemon('Burpmon', 510, 7),
        new DungeonTrainer('Bug Catcher',
            [new GymPokemon('Burpmon', 510, 9)],
            { weight: 1 }, 'Sammy'),
    ],
    50, 1);

dungeonList['Burpmons Cave'] = new Dungeon('Burpmons Cave',
    ['Burpmon'],
    [
        {loot: 'xClick', weight: 4},
        {loot: 'Lucky_floppy', weight: 4},
        {loot: 'Mystery_egg', weight: 1, requirement: new ClearDungeonRequirement(100, GameConstants.getDungeonIndex('Burpmons Cave'))},
...
dungeonList['Mt. Moon'] = new Dungeon('Mt. Moon',
    [
        ...
        new DungeonTrainer('Bug Catcher',
            [
                new GymPokemon('Burpmon', 75, 11),
                new GymPokemon('Burpmon', 75, 11),
            ], { weight: 1 }, 'Kent'),
        new DungeonTrainer('Lass',
            [new GymPokemon('Burpmon', 75, 14)],
            { weight: 1 }, 'Iris'),
    ...
    [
        new DungeonTrainer('Super Nerd',
            [
                new GymPokemon('Burpmon', 2780, 12),
                new GymPokemon('Burpmon', 2780, 12),
                new GymPokemon('Burpmon', 2780, 12),
            ], { weight: 1 }, 'Miguel'),
    ],
...
dungeonList['Rock Tunnel'] = new Dungeon('Rock Tunnel',
    [
        {pokemon: 'Burpmon', options: { weight: 20 }},
        {pokemon: 'Burpmon', options: { weight: 20 }},
        {pokemon: 'Burpmon', options: { weight: 20 }},
        new DungeonTrainer('PokéManiac',
            [
                new GymPokemon('Burpmon', 500, 23),
                new GymPokemon('Burpmon', 500, 23),
            ], { weight: 1 }, 'Ashton'),
        new DungeonTrainer('PokéManiac',
            [new GymPokemon('Burpmon', 500, 25)],
            { weight: 1 }, 'Winston'),
        new DungeonTrainer('Picnicker',
            [
                new GymPokemon('Burpmon', 500, 22),
                new GymPokemon('Burpmon', 500, 22),
            ], { weight: 1 }, 'Martha'),
        new DungeonTrainer('PokéManiac',
            [
        ...
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Burpmon', 500, 20),
                new GymPokemon('Burpmon', 500, 20),
            ], { weight: 1 }, 'Eric'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Burpmon', 500, 19),
                new GymPokemon('Burpmon', 500, 19),
                new GymPokemon('Burpmon', 500, 19),
                new GymPokemon('Burpmon', 500, 19),
            ], { weight: 1 }, 'Lenny'),
    ...
    4117,
    [
        new DungeonBossPokemon('Burpmon', 20585, 17),
        new DungeonTrainer('Picnicker',
            [
                new GymPokemon('Burpmon', 5147, 19),
                new GymPokemon('Burpmon', 5147, 19),
                new GymPokemon('Burpmon', 5147, 19),
                new GymPokemon('Burpmon', 5147, 19),
            ], { weight: 1 }, 'Ariana'),
...
dungeonList['Power Plant'] = new Dungeon('Power Plant',
    ...
    13507,
    [
        new DungeonBossPokemon('Burpmon', 67535, 35),
        new DungeonBossPokemon('Burpmon', 101302, 50),
    ],
    1000, 8);

dungeonList['Pokemon Tower'] = new Dungeon('Pokemon Tower',
    [
        {pokemon: 'Burpmon', options: { weight: 21.3 }},
        {pokemon: 'Burpmon', options: { weight: 21.3 }},
        {pokemon: 'Burpmon', options: { weight: 21.3 }},
        new DungeonTrainer('Channeler',
            [new GymPokemon('Burpmon', 750, 23)],
            { weight: 1 }, 'Hope'),
        new DungeonTrainer('Channeler',
            [new GymPokemon('Burpmon', 750, 22)],
            { weight: 1 }, 'Patricia'),
        new DungeonTrainer('Channeler',
            [new GymPokemon('Burpmon', 750, 24)],
            { weight: 1 }, 'Carly'),
        new DungeonTrainer('Channeler',
            [
                new GymPokemon('Burpmon', 750, 23),
        ...
        new DungeonTrainer('Team Rocket Grunt',
            [
                new GymPokemon('Burpmon', 750, 25),
                new GymPokemon('Burpmon', 750, 25),
                new GymPokemon('Burpmon', 750, 25),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Rocket Grunt',
            [
                new GymPokemon('Burpmon', 750, 26),
                new GymPokemon('Burpmon', 750, 26),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Rocket Grunt',
            [
    ...
    7523,
    [new DungeonBossPokemon('Burpmon', 37615, 30)],
    750, 10);
...
dungeonList['Seafoam Islands'] = new Dungeon('Seafoam Islands',
    ...
    17226,
    [
        new DungeonBossPokemon('Burpmon', 86130, 35),
        new DungeonBossPokemon('Burpmon', 129195, 50),
    ],
    1250, 15);
...
dungeonList['Pokemon Mansion'] = new Dungeon('Pokemon Mansion',
    [
        ...
        new DungeonTrainer('Youngster',
            [
                new GymPokemon('Burpmon', 1500, 33),
                new GymPokemon('Burpmon', 1500, 33),
                new GymPokemon('Burpmon', 1500, 34),
            ], { weight: 1 }, 'Johnson'),
        ...
        new DungeonTrainer('Burglar',
            [new GymPokemon('Burpmon', 1500, 38)],
            { weight: 1 }, 'Simon'),
        ...
        new DungeonTrainer('Scientist',
            [
                new GymPokemon('Burpmon', 1500, 29),
                new GymPokemon('Burpmon', 1500, 29),
            ], { weight: 1 }, 'Ted', '(male)'),
        new DungeonTrainer('Burglar',
            [
    ...
    [
        ...
        {loot: 'Burpmonizer', weight: 0, requirement: new ClearDungeonRequirement(200, GameConstants.getDungeonIndex('Pokemon Mansion'))},
    ],
    17760,
    [new DungeonBossPokemon('Burpmon', 88800, 40)],
    1500, 16);
...
dungeonList['Victory Road'] = new Dungeon('Victory Road',
    [
        ...
        new DungeonTrainer('Cooltrainer',
            [
                new GymPokemon('Burpmon', 2000, 42),
                new GymPokemon('Burpmon', 2000, 42),
                new GymPokemon('Burpmon', 2000, 42),
                new GymPokemon('Burpmon', 2000, 42),
                new GymPokemon('Burpmon', 2000, 42),
        ...
        new DungeonTrainer('Black Belt',
            [
                new GymPokemon('Burpmon', 2000, 43),
                new GymPokemon('Burpmon', 2000, 43),
                new GymPokemon('Burpmon', 2000, 43),
            ], { weight: 1 }, 'Daisuke'),
        new DungeonTrainer('Juggler',
            [
                new GymPokemon('Burpmon', 2000, 41),
                new GymPokemon('Burpmon', 2000, 41),
                new GymPokemon('Burpmon', 2000, 41),
                new GymPokemon('Burpmon', 2000, 41),
            ], { weight: 1 }, 'Nelson'),
        new DungeonTrainer('Tamer',
            [
                new GymPokemon('Burpmon', 2000, 44),
                new GymPokemon('Burpmon', 2000, 44),
            ], { weight: 1 }, 'Vincent'),
        new DungeonTrainer('Juggler',
            [new GymPokemon('Burpmon', 2000, 48)],
            { weight: 1 }, 'Gregory'),
        new DungeonTrainer('Cooltrainer',
            [
                new GymPokemon('Burpmon', 2000, 42),
        ...
        new DungeonTrainer('PokéManiac',
            [
                new GymPokemon('Burpmon', 2000, 40),
                new GymPokemon('Burpmon', 2000, 40),
                new GymPokemon('Burpmon', 2000, 40),
            ], { weight: 1 }, 'Dawson'),
        new DungeonTrainer('Cooltrainer',
    ...
    24595,
    [
        new DungeonBossPokemon('Burpmon', 122975, 42),
        new DungeonBossPokemon('Burpmon', 184462, 50),
        new DungeonTrainer('Cool Couple',
            [
                new GymPokemon('Burpmon', 61488, 45),
                new GymPokemon('Burpmon', 61488, 45),
            ], { weight: 1 }, 'Ray & Tyra'),
    ],
    2000, 20);
...
dungeonList['Cerulean Cave'] = new Dungeon('Cerulean Cave',
    ['Burpmon', 'Burpmon', 'Burpmon', 'Burpmon', 'Burpmon', 'Burpmon', 'Burpmon', 'Burpmon', 'Burpmon', 'Burpmon', 'Burpmon', 'Burpmon', 'Burpmon', 'Burpmon', 'Burpmon'],
    [
    ...
    28735,
    [
        new DungeonBossPokemon('Burpmon', 183675, 60),
        new DungeonBossPokemon('Burpmon', 255512, 100),
    ],
    2500, 20);
...
dungeonList['Radio Tower'] = new Dungeon('Radio Tower',
    ...
    [
        {loot: 'xClick', weight: 3.75},
        {loot: 'Lucky_pill', weight: 3.75},
        {loot: 'FightDisk', weight: 2},
        {loot: 'ToughDisk', weight: 2},
        {loot: 'ChargeDisk', weight: 2},
        {loot: 'OracleDisk', weight: 2},
        {loot: 'EnergyDisk', weight: 2},
        {loot: 'MageDisk', weight: 2},
        {loot: 'Figy', weight: 2},
        {loot: 'Wiki', weight: 2},
        {loot: 'Mago', weight: 2},
        {loot: 'Aguav', weight: 2},
...
dungeonList['Team Galactic Eterna Building'] = new Dungeon('Team Galactic Eterna Building',
    ...
    [
        ...
        new DungeonBossPokemon('Burpmon (heat)', 4300000, 100, {requirement: new MultiRequirement([
            new ObtainedPokemonRequirement(pokemonMap.Burpmon),
            new ClearDungeonRequirement(1, GameConstants.getDungeonIndex('Team Galactic Eterna Building')),
        ])}),
        new DungeonBossPokemon('Burpmon (wash)', 4300000, 100, {requirement: new MultiRequirement([
            new ObtainedPokemonRequirement(pokemonMap.Burpmon),
            new ClearDungeonRequirement(1, GameConstants.getDungeonIndex('Team Galactic Eterna Building')),
        ])}),
        new DungeonBossPokemon('Burpmon (frost)', 4300000, 100, {requirement: new MultiRequirement([
            new ObtainedPokemonRequirement(pokemonMap.Burpmon),
            new ClearDungeonRequirement(1, GameConstants.getDungeonIndex('Team Galactic Eterna Building')),
        ])}),
        new DungeonBossPokemon('Burpmon (fan)', 4300000, 100, {requirement: new MultiRequirement([
            new ObtainedPokemonRequirement(pokemonMap.Burpmon),
            new ClearDungeonRequirement(1, GameConstants.getDungeonIndex('Team Galactic Eterna Building')),
        ])}),
        new DungeonBossPokemon('Burpmon (mow)', 4300000, 100, {requirement: new MultiRequirement([
            new ObtainedPokemonRequirement(pokemonMap.Burpmon),
            new ClearDungeonRequirement(1, GameConstants.getDungeonIndex('Team Galactic Eterna Building')),
        ])}),
    ],
...
dungeonList['Floccesy Ranch'] = new Dungeon('Floccesy Ranch',
    ...
    [
        ...
        {loot: 'Pokeball', weight: 4},
        {loot: 'Cheri', weight: 3.5},
        {loot: 'OracleDisk', weight: 2.5},
        {loot: 'EnergyDisk', weight: 2.5},
    ],
    2503000,
...
dungeonList['Relic Castle'] = new Dungeon('Relic Castle',
    ...
    [
        ...
        {loot: 'Sun_stone', weight: 0},
        {loot: 'Heart Scale', weight: 0},
        {loot: 'Burpmon (Zen)', weight: 0, requirement: new ClearDungeonRequirement(50, GameConstants.getDungeonIndex('Relic Castle'))},
...
dungeonList['Dragonspiral Tower'] = new Dungeon('Dragonspiral Tower',
    ['Burpmon', 'Burpmon', 'Basculin (Red-Striped)', 'Basculin (Blue-Striped)', 'Burpmon', 'Sawsbuck (Autumn)', 'Sawsbuck (Winter)', 'Burpmon', 'Burpmon', 'Burpmon', 'Burpmon', 'Burpmon', 'Burpmon'],
    [
        {loot: 'xAttack', weight: 4},
        {loot: 'ToughDisk', weight: 3.5},
        {loot: 'MageDisk', weight: 3.5},
        {loot: 'Draco Plate', weight: 2.5},
        {loot: 'Zap Plate', weight: 2.5},
        {loot: 'Flame Plate', weight: 2.5},
        {loot: 'Icicle Plate', weight: 2},
...
dungeonList['Pledge Grove'] = new Dungeon('Pledge Grove',
    ['Burpmon', 'Burpmon', 'Burpmon', 'Burpmon', 'Burpmon', 'Burpmon', 'Burpmon', 'Sawsbuck (Autumn)', 'Sawsbuck (Winter)'],
    [
        {loot: 'xAttack', weight: 4},
        {loot: 'Lucky_pill', weight: 3.75},
        {loot: 'Ultraball', weight: 3.5},
    ...
    5203000,
    [new DungeonBossPokemon('Burpmon (Resolute)', 52000000, 100)],
    356500, 8);
    ...
    [
        ...
        new DungeonTrainer('Team Plasma',
            [
                ...
                new GymPokemon('Burpmon (wash)', 10000000, 72),
                new GymPokemon('Burpmon', 10000000, 72),
                new GymPokemon('Burpmon', 10000000, 72),
                new GymPokemon('Burpmon', 10000000, 72),
...
dungeonList['Lost Hotel'] = new Dungeon('Lost Hotel',
    ...
    [
        ...
        {loot: 'Burpmon (heat)', weight: 0},
        {loot: 'Burpmon (wash)', weight: 0},
        {loot: 'Burpmon (fan)', weight: 0},
        {loot: 'Burpmon (frost)', weight: 0},
        {loot: 'Burpmon (mow)', weight: 0},
        {loot: 'Protector', weight: 0},
...
dungeonList['Burpmon Valley'] = new Dungeon('Burpmon Valley',
    ...
    11952804,
    [
        new DungeonBossPokemon('Burpmon (Original cap)', 59764020, 15),
        new DungeonBossPokemon('Burpmon (Hoenn cap)', 59764020, 15),
        new DungeonBossPokemon('Burpmon (Sinnoh cap)', 59764020, 15),
        new DungeonBossPokemon('Burpmon (Unova cap)', 59764020, 15),
        new DungeonBossPokemon('Burpmon (Kalos cap)', 59764020, 15),
        new DungeonBossPokemon('Burpmon (Alola cap)', 59764020, 15),
    ],
    850000, 4);
...
dungeonList['Burpmon Island Hill'] = new Dungeon('Burpmon Island Hill',
    ['Burpmon', 'Burpmon', 'Gastrodon (east)'],
    [{loot: 'xClick', weight: 4}, {loot: 'Item_magnet', weight: 4}],
    15773066,
    [
...
dungeonList['Ruins of Conflict'] = new Dungeon('Ruins of Conflict',
    ['Floette (Red)', 'Burpmon', 'Burpmon', 'Burpmon', 'Burpmon'],
    [{loot: 'xClick', weight: 4}, {loot: 'Item_magnet', weight: 4}],
    16435490,
    [
